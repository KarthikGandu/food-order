...
<head>
    ...
    <link rel="icon" href="images/unt.png" style="opacity:0.5">
    <title>UNT FOOD COURT</title>
    <!-- Bootstrap core CSS -->
        ...
        <header id="header" class="header-scroll top-header headrom">
            ...
            <nav class="navbar navbar-dark">
                <div class="container">
                    ...
                    <a class="navbar-brand" href="index.php"> <img class="img-rounded" src="images/unt.png" alt=""> </a>
            ...
            <div class="container">
                ...
                <div class="row top-footer">
                    <div class="col-xs-12 col-sm-3 footer-logo-block color-gray">
                        <a href="#"> <img src="images/unt.png" alt="Footer logo"> </a> <span>Order Delivery &amp; Take-Out </span> </div>
                ...
                <div class="bottom-footer">
                    <div class="row">
                        ...
                        <div class="col-xs-12 col-sm-4 address color-gray">
                            ...
                            <h5>Phone: <a href="tel:+19407358331" style="font:Sans-serif">+1 940-735-8331</a></h5> </div>
                        <div class="col-xs-12 col-sm-5 additional-info color-gray">
                            <h5>Copyrights</h5>
                            <p>All rights are reserved to Karthik G 2021 ®</p>
                        </div>
                    </div>
                </div>
                <!-- bottom footer ends -->
